...
export const novelsApi = {
  ...
  getChapters: (slug: string) =>
    apiCall('GET', `/api/novels/${slug}/chapters`),
  ...
  deleteChapter: (slug: string, number: number, token: string) =>
    apiCall('DELETE', `/api/novels/${slug}/chapters/${number}`, undefined, token),
};
